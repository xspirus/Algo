...
Pair find_collision(int size, int len, double &timeLeft, double &timeRight, vector<Particle> &left, vector<Particle> &right);
...
int main() {
    ...
    //for (i = 0; i < cannons; i++)
    //    cout << "endLeft[" << endLeft[i].index << "] = " << endLeft[i].endTime << endl;

    //for (i = 0; i < cannons; i++)
    //    cout << "endRight[" << endRight[i].index << "] = " << endRight[i].endTime << endl;
...
Pair find_collision(int size, int len, double &timeLeft, double &timeRight, vector<Particle> &left, vector<Particle> &right) {
    ...
    while ((timeRight - timeLeft) > 0.0001) {
    ...
    timeLeft = timeRight;
    //cout << "Result of collision: " << result.left << " " << result.right << endl;
